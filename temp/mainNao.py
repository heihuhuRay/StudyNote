...
PatternOsc1 = RG_Patterns(10,10,1,0.05)
PatternOsc2 = RG_Patterns(5,5,1,0.1) 

PatternOsc3 = RG_Patterns(2,10,1,0.1) # This is a smooth patern 
#PatternOsc3 = PatternOsc2
...
LHR_PFPattern = PF_Patterns(0.045,0)
RHR_PFPattern = LHR_PFPattern

LAR_PFPattern = PF_Patterns(0.045,0)
...
myCont[L_SHOULDER_PITCH].fSetPatternRG(PatternOsc3) # PatternPL1 PatternOsc3 PatternAosc PatternQU

myCont[L_SHOULDER_ROLL].fSetPatternPF(LSP_PFPattern)
myCont[L_SHOULDER_ROLL].fSetPatternRG(PatternOsc3) # PatternPL1 PatternOsc3 PatternAosc PatternQU

myCont[R_SHOULDER_PITCH].fSetPatternPF(LSP_PFPattern)
myCont[R_SHOULDER_PITCH].fSetPatternRG(PatternOsc3) # PatternPL1 PatternOsc3 PatternAosc PatternQU

myCont[R_SHOULDER_ROLL].fSetPatternPF(LSP_PFPattern)
myCont[R_SHOULDER_ROLL].fSetPatternRG(PatternOsc3) # PatternPL1 PatternOsc3 PatternAosc PatternQU



myCont[L_HIP_ROLL].fSetPatternPF(LHR_PFPattern)
myCont[L_HIP_ROLL].fSetPatternRG(PatternOsc3) # PatternPL1 PatternOsc3 PatternAosc PatternQU

myCont[R_HIP_ROLL].fSetPatternPF(RHR_PFPattern)
myCont[R_HIP_ROLL].fSetPatternRG(PatternOsc3) # PatternPL1 PatternOsc3 PatternAosc PatternQU

myCont[L_ANKLE_ROLL].fSetPatternPF(LAR_PFPattern)
myCont[L_ANKLE_ROLL].fSetPatternRG(PatternOsc3) # PatternPL1 PatternOsc3 PatternAosc PatternQU

myCont[R_ANKLE_ROLL].fSetPatternPF(RAR_PFPattern)
myCont[R_ANKLE_ROLL].fSetPatternRG(PatternOsc3) # PatternPL1 PatternOsc3 PatternAosc PatternQU

# for pitch legs motors 
myCont[R_HIP_PITCH].fSetPatternPF(RHP_PFPattern)
myCont[R_HIP_PITCH].fSetPatternRG(PatternOsc3) # PatternPL1 PatternOsc3 PatternAosc PatternQU

myCont[R_KNEE_PITCH].fSetPatternPF(RKP_PFPattern)
myCont[R_KNEE_PITCH].fSetPatternRG(PatternOsc3) # PatternPL1 PatternOsc3 PatternAosc PatternQU

myCont[R_ANKLE_PITCH].fSetPatternPF(RAP_PFPattern)
myCont[R_ANKLE_PITCH].fSetPatternRG(PatternOsc3) # PatternPL1 PatternOsc3 PatternAosc PatternQU



myCont[L_HIP_PITCH].fSetPatternPF(LHP_PFPattern)
myCont[L_HIP_PITCH].fSetPatternRG(PatternOsc3) # PatternPL1 PatternOsc3 PatternAosc PatternQU

myCont[L_KNEE_PITCH].fSetPatternPF(LKP_PFPattern)
myCont[L_KNEE_PITCH].fSetPatternRG(PatternOsc3) # PatternPL1 PatternOsc3 PatternAosc PatternQU

myCont[L_ANKLE_PITCH].fSetPatternPF(LAP_PFPattern)
myCont[L_ANKLE_PITCH].fSetPatternRG(PatternOsc3) # PatternPL1 PatternOsc3 PatternAosc PatternQU
